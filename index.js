...
/******** OWNER NUMBER**********/
const ownerNumber = ["584145982731@s.whatsapp.net","6282334297175@s.whatsapp.net"] 
/************************************/
            ...
            case 'bitly':
               ...
               case 'help': 
         	   ...
         	   case 'creator':
                  ...
                  client.sendMessage(from, 'Ese es mi número de propietario> _ <, no envíes spam o te bloqueo',MessageType.text, { quoted: mek} )
					break    
				case 'leaderboard':
				case 'lb':
				bo = args[0]
